...
[Here is a brief video demonstration](https://share.descript.com/view/vlV7S3cEM0F). As you watch the video, pause it frequently and **READ** the relevant lesson sections. There is much more detail in the text than in the video. **You will not get full credit for the lesson if you do not "Run" every code block.**
</div>
